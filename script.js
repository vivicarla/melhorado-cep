...
formulario.addEventListener("submit",async(evento)=>{
    ...
    resultado.innerHTML="<img src='Loading_2.gif'>";
    try{
        ...
        if(dados.error){
            ...
            "Bairro: "+dados.bairro+"<br> Cidade:"+dados.localidade+"-"+dados.uf;
            ...
            if(dadosGeoJson.results && dadosGeoJson.results.length>0 ){
                ...
                const velocidade = climaJson.current_weather.windspeed;
                const resultadoClima = "<br>Temperatura: "+temperatura+"°C"+"<br>"+"Velocidade do Vento: "+velocidade+"Km/h.";
